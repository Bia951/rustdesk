...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("kms_capture_tip", "Experimental Linux KMS capture backend. A software restart is required after changing this option."),
        ("Use KMS as graphics capture backend", "Use KMS as graphics capture backend"),
