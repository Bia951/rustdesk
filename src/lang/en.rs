...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("kmsgrab_capture_tip", "Experimental Linux capture backend. Uses kmsgrab when enabled. A software restart is required after changing this option."),
        ("Use kmsgrab as graphics capture backend", "Use kmsgrab as graphics capture backend"),
