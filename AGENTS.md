...
This file provides guidance to Codex (chatgpt.com/codex/cloud) when working with code in this repository.
...
- Do not run repository-wide formatters or reflow unrelated code unless the user explicitly asks for formatting.
